        ...
        <header class="header">
            ...
            <div class="header__text-box">
                <h1 class="heading-primary">
                    <span class="heading-primary--main">Incollab</span>
                    <span class="heading-primary--sub">Customer Focused Digital Products</span>
                </h1>

                <a href="#section-tours" class="btn btn--white btn--animated">Explore</a>
            </div>
        </header>
        ...
        <main>
            <section class="section-about">
                <div class="u-center-text u-margin-bottom-big">
                    <h2 class="heading-secondary">
                        Our Process From Start to Finish And Beyond
                    </h2>
                </div>
            ...
            <section class="section-tours" id="section-tours">
                       ...
                       <div class="card">
                           <div class="card__side card__side--front">
                                ...
                                <h4 class="card__heading">
                                    <span class="card__heading-span card__heading-span--1">Website Package</span>
                                </h4>
                    ...
                    <div class="col-1-of-3">
                        <div class="card">
                            <div class="card__side card__side--front">
                                ...
                                <h4 class="card__heading">
                                    <span class="card__heading-span card__heading-span--2">Web App Package</span>
                                </h4>
                                <div class="card__details">
                                    <ul>
                                        <li>7 day tours</li>
                    ...
                    <div class="col-1-of-3">
                        <div class="card">
                            <div class="card__side card__side--front">
                                ...
                                <h4 class="card__heading">
                                    <span class="card__heading-span card__heading-span--3">Mobile App Package</span>
                                </h4>
                                <div class="card__details">
                                    <ul>
                                        <li>5 day tours</li>
                ...
                <div class="u-center-text u-margin-top-huge">
                    <a href="#" class="btn btn--green">Discover all packages</a>
                </div>
            </section>
